...
urlpatterns = [
    ...
    path("excluir_lar_temporario_atual_ajax/<int:lar_atual_id>/", views.excluir_lar_temporario_atual_ajax, name="excluir_lar_temporario_atual_ajax"), # Pop-up de confirmar exclusão do lar temporário atual
